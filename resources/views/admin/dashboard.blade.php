...
@section('content')
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-6">
                    <h2 class="text-xl font-semibold text-gray-900 mb-2">Welcome to the Admin Dashboard!</h2>
                    <p class="text-gray-600">Manage your electronics store from this dashboard. Use the sidebar to navigate between Users, Products, Categories, and Orders.</p>
                </div>
            </div>
        </div>
    </div>
